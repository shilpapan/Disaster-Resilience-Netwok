<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Signup.aspx.cs" Inherits="DRSN.User_Interface.Signup.Signup" %>
	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" id="form2" runat="server" method="get" action="Authenticate.aspx">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						...
						<asp:TextBox class="input100" type="password" name="password" id="password" placeholder="*************" runat="server"/>
						<span class="focus-input100"></span>
					</div>
					...
					<div class="flex-m w-full p-b-33">
						<div class="contact100-form-checkbox">
							<asp:TextBox class="input-checkbox100" id="ckb1" type="checkbox" name="remember-me" runat="server"/>
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<asp:Button class="login100-form-btn" runat="server" ForeColor="#CC00CC" Text="Sign up" ID="signu" OnClick="createaccount">
